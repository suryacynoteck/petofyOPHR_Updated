...
import com.cynoteck.petofyOPHR.response.FollowUp;
import com.cynoteck.petofyOPHR.response.getPetReportsResponse.NatureOfVisit;
import com.cynoteck.petofyOPHR.response.getPetReportsResponse.getClinicVisitDetails.PetAgeList;

public class GetMyVisitPetRecordPetClinicVisitList {
    ...
    {
        return "ClassPojo [natureOfVisitList = "+natureOfVisitList+", dewormerDose = "+dewormerDose+", petId = "+petId+", petAge = "+petAge+", documents = "+documents+", createdByUser = "+createdByUser+", description = "+description+", weightOz = "+weightOz+", followUpId = "+followUpId+", petAgeList = "+petAgeList+", vaccinationModels = "+vaccinationModels+", createdOn = "+createdOn+", petName = "+petName+", followUp = "+followUp+", dateOfOnset = "+dateOfOnset+", petParentName = "+petParentName+", contactNumber = "+contactNumber+", temperature = "+temperature+", treatmentRemarks = "+treatmentRemarks+", visitDate = "+visitDate+", natureOfVisitId = "+natureOfVisitId+", id = "+id+", petUniqueId = "+petUniqueId+", pet = "+pet+", updatedByUser = "+updatedByUser+", weightLbs = "+weightLbs+", petSex = "+petSex+", updatedBy = "+updatedBy+", followUpList = "+followUpList+", history = "+history+", updatedOn = "+updatedOn+", veterinarianUserId = "+veterinarianUserId+", natureOfVisit = "+natureOfVisit+", dewormerName = "+dewormerName+", encryptedPetId = "+encryptedPetId+", symptoms = "+symptoms+", followUpDate = "+followUpDate+", vaccine = "+vaccine+", createdBy = "+createdBy+", diagnosisProcedure = "+diagnosisProcedure+", appointmentId = "+appointmentId+", encryptedId = "+encryptedId+", veterinarian = "+veterinarian+", petDOB = "+petDOB+", optionalVaccine = "+optionalVaccine+", navStatus = "+navStatus+"]";
    }
}
