...
public class AddPetModel {
    ...
    {
        return "ClassPojo [encryptedId = "+encryptedId+", userId = "+userId+", petCategoryId = "+petCategoryId+"," +
                " petSexId = "+petSexId+", petAgeId = "+petAgeId+", petSizeId = "+petSizeId+"," +
                " petColorId = "+petColorId+", petBreedId = "+petBreedId+", petName = "+petName+", " +
                "petParentName = "+petParentName+", contactNumber = "+contactNumber+", address = "+address+", " +
